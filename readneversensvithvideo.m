...
dat1=readmatrix("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch2_gages.tsv",FileType="text",Delimiter='\t',Range=[35 6]);
loc1=readmatrix("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch2_gages.tsv",FileType="text",Delimiter='\t',Range=[34 6 34 6+size(dat1,2)]);
time1=readtable("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch2_gages.tsv",FileType="text",Delimiter='\t',Range=[35 1 35+size(dat1,1) 1]);
time1=time1.Var1;
...
dat2=readmatrix("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch1_gages.tsv",FileType="text",Delimiter='\t',Range=[35 6]);
loc2=readmatrix("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch1_gages.tsv",FileType="text",Delimiter='\t',Range=[34 6 34 6+size(dat2,2)]);
time2=readtable("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch1_gages.tsv",FileType="text",Delimiter='\t',Range=[35 1 35+size(dat2,1) 1]);
time2=time2.Var1;
...
dat4=readmatrix("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch4_gages.tsv",FileType="text",Delimiter='\t',Range=[35 6]);
loc4=readmatrix("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch4_gages.tsv",FileType="text",Delimiter='\t',Range=[34 6 34 6+size(dat4,2)]);
time4=readtable("neversenswithvideo/shapesensing_video_2024-11-19_02-59-48_ch4_gages.tsv",FileType="text",Delimiter='\t',Range=[35 1 35+size(dat4,1) 1]);
time4=time4.Var1;
