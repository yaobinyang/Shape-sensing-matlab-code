...
n_samples=1000;
n_substep=1;
strain_N=readmatrix("data/newdata/ClaremontNorth36_N_tc_OLD.csv");
Times = readcell('data/newdata/ClaremontNorth36_N_tc_OLD.csv','range',"1:1");
strain_N=strain_N(2:end,:);
strain_N=flip(strain_N,1);
strain_S=readmatrix("data/newdata/ClaremontNorth36_S_tc_OLD.csv");
strain_S=strain_S(2:end,:);
strain_S=flip(strain_S,1);
strain_Z=readmatrix("data/newdata/ClaremontNorth36_Z_tc_OLD.csv");
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'lateraldisperror.png')
%%
figure(20001)
...
vw = VideoWriter("simpsupportvideo");
vw.FrameRate=1/0.6;
open(vw)
