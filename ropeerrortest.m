...
design_uk_all=0*[0.1;0;0]*ones(size(s_all))+0*[-0.1;0;0]*sin(2*pi*s_all/s_all(end));
design_vk_all=[0;0;1]*ones(size(s_all))+0*[0;0;0]*ones(size(s_all))+0*[-0.05;0.4;0.1]*ones(size(s_all))+0*[0.1;0;0.01]*sin(2*pi*s_all/s_all(end));
