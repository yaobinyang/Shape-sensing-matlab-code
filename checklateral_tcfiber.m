...
strain_N=readmatrix("claremont_data/ClaremontNorth36_N_tc_fiber.csv");
Times = readcell('claremont_data/ClaremontNorth36_N_tc_fiber.csv','range',"1:1");
strain_N=strain_N(2:end,:);
strain_S=readmatrix("claremont_data/ClaremontNorth36_S_tc_fiber.csv");
strain_S=strain_S(2:end,:);
strain_Z=readmatrix("claremont_data/ClaremontNorth36_Z_tc_fiber.csv");
...
grid on
xlim([0,max(s)]);
saveas(gcf,'claremont_data/lateraldisp_tcfiber.png')
figure(10002)
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'claremont_data/lateraldisperror_tcfiber.png')
%%
figure(20001)
...
set(gcf,"Position",[10         478        1917         518])
grid on
saveas(gcf,'claremont_data/axialdisp_tcfiber.png')
figure(20002)
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'claremont_data/axialdisperror_tcfiber.png')
%%
...
vw = VideoWriter("claremont_data/simpsupportvideo_tcfiber","Motion JPEG AVI");
vw.FrameRate=1/0.6;
open(vw)
...
vw = VideoWriter("claremont_data/axialdispvideo_tcfiber","Motion JPEG AVI");
vw.FrameRate=1/0.6;
open(vw)
for slicetimeid=1:1:42
    figure(40001)
