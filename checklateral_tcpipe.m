...
grid on
xlim([0,max(s)]);
saveas(gcf,'claremont_data/lateraldisp_tcpipe.png')
figure(10002)
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'claremont_data/lateraldisperror_tcpipe.png')
%%
figure(20001)
...
set(gcf,"Position",[10         478        1917         518])
grid on
saveas(gcf,'claremont_data/axialdisp_tcpipe.png')
figure(20002)
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'claremont_data/axialdisperror_tcpipe.png')
%%
...
vw = VideoWriter("claremont_data/simpsupportvideo_tcpipe","Motion JPEG AVI");
vw.FrameRate=1/0.6;
open(vw)
...
vw = VideoWriter("claremont_data/axialdispvideo_tcpipe","Motion JPEG AVI");
vw.FrameRate=1/0.6;
open(vw)
for slicetimeid=1:1:42
    figure(40001)
