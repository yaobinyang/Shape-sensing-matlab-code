...
grid on
xlim([0,max(s)]);
saveas(gcf,'claremont_data/lateraldisp_raw.png')
figure(10002)
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'claremont_data/lateraldisperror_raw.png')
%%
figure(20001)
...
set(gcf,"Position",[10         478        1917         518])
grid on
saveas(gcf,'claremont_data/axialdisp_raw.png')
figure(20002)
...
ax.FontSize = ftsz;
set(gcf,"Position",[10         478        1917         518])
saveas(gcf,'claremont_data/axialdisperror_raw.png')
%%
...
vw = VideoWriter("claremont_data/simpsupportvideo_raw","Motion JPEG AVI");
vw.FrameRate=1/0.6;
open(vw)
...
vw = VideoWriter("claremont_data/axialdispvideo_raw","Motion JPEG AVI");
vw.FrameRate=1/0.6;
open(vw)
for slicetimeid=1:1:42
    figure(40001)
