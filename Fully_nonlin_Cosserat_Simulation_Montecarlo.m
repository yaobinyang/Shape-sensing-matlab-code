...
parfor sample=1:n_samples
    ...
    [r_all,D_ik_all,D0_ik_all_,u0_k_all_,v0_k_all_,u_k_all_,v_k_all_]...
        =Fully_nonlin_Cosserat_simulation(R_helix,R_straight,omega_helix,omega_straight,theta_helix_0,theta_straight_0,n_helix,n_straight,s_all,rod_axis_rs,isassigneddir,assigned_dir,errored_helix_cable_strain_all,errored_straight_cable_strain_all,measure_error_level,0,n_substep);
